...
replace github.com/Mrs4s/go-cqhttp v1.0.0-rc1 => github.com/xiaeroc/go-cqhttp v1.0.2-xiaeroc
...
require (
	...
	github.com/Mrs4s/MiraiGo v0.0.0-20220621083050-ae8c187aa59d // indirect
